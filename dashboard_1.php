        ...
        <div class="wrapper">
            ...
            <main class="content mt-4">
                <div class="container-fluid p-0">
                    <h1 class="h3 mb-3 mt-0 d-none d-lg-block d-xl-block"><strong>Analytics</strong> Dashboard</h1>
                    <div class="row">
                ...
                <div class="row col-12 col-xxl-12 col-lg-12">
                                ...
                                <div class="align-self-center w-100">
                                    ...
                                    <table class="table mb-0">
                                        <tbody>
                                            <?php
                                            $cat_ex = $cat_na = [];
                                            $result = $db->exc_q("SELECT cat,SUM(amount) FROM `debits` GROUP BY `cat` ORDER BY SUM(amount) DESC LIMIT 5");
                    ...
                    <div class="col-lg-5 col-xxl-5">
                        <div class="card">
                            ...
                            <?= $db->build_calendar(date("m"), date("Y")); ?>
                            <table>
                                <thead>
                                    <tr>
                                        <th>#</th>
                        ...
                        <div class="card">
                            <div class="card-body bg-dark">
                                <div class="row">
                                    ...
                                    $y = date("Y");
                                    $m = date("m");
                                    $mon_ex_cat = $db->exc_q("SELECT cat,SUM(amount) FROM `debits` WHERE `date` LIKE '%" . $y . "-" . $m . "%' GROUP BY cat ORDER BY SUM(amount) DESC LIMIT 1", 1);
                                    $cat_det = $db->exc_q("SELECT * FROM `deb_cat` WHERE `d_id`=" . $mon_ex_cat["cat"], 1);
                                    $deb_t_cat_lm = $db->exc_q("SELECT SUM(amount) FROM `debits` WHERE `date` LIKE '%$prev_ym%' AND `cat`=" . $mon_ex_cat["cat"], 1)["SUM(amount)"];
                                    ?>
                                    <div class="col mt-0">
                                ...
                                <h1 class="mt-1 mb-3 text-white"><?= number_format($mon_ex_cat["SUM(amount)"], 2, ".", ",") ?></h1>
                                <div class="mb-0">
                                    <span class="text-muted">last month</span>
                ...
                <div class="row col-lg-12 col-xxl-12 d-none d-lg-block d-xl-block">
                    <div class="card flex-fill">
                        <div class="card-header">
                            <h5 class="card-title mb-0">In <?= $y ?>, Category Wise Expesnses</h5>
                        </div>
                        <table class="table table-hover my-0">
                            ...
                            <tbody>
                                ...
                                while ($deb_cat_row = mysqli_fetch_array($deb_cat_re)) {
                                    ...
                                    $deb_cat_avg_max = $db->find_avg_max_exp($y, $m, $cat);
                                    $total = 0;
                                    ?>
                                    <tr>
                                        <td><?= ++$index ?></td>
                                        ...
                                        <?php
                                        for ($i = 1; $i <= 12; $i++) {
                                            $deb = floatval($db->exc_q("SELECT SUM(amount) FROM `debits` WHERE `date` LIKE '%$y" . "-" . sprintf("%02s", $i) . "%' AND `cat`=$cat", 1)["SUM(amount)"]);
                                            $total += $deb;
                                            $mon_cat_deb[$i - 1] += $deb;
                                            $in_cl = "";
                ...
                <div class="row col-lg-12 col-xxl-12 d-none d-lg-block d-xl-block">
                    <div class="card flex-fill">
                        <div class="card-header">
                            <h5 class="card-title mb-0">In <?= $y ?>, Total Balances</h5>
                        </div>
                        <table class="table table-hover my-0">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                ...
                                $mon_arr_deb = [];
                                for ($i = 1; $i <= 12; $i++) {
                                    $cre = $db->exc_q("SELECT SUM(amount) FROM `credits` WHERE `date` LIKE '%$y" . "-" . sprintf("%02s", $i) . "%'", 1);
                                    $deb = $db->exc_q("SELECT SUM(amount) FROM `debits` WHERE `date` LIKE '%$y" . "-" . sprintf("%02s", $i) . "%'", 1);
                        ...
                        <div class="card flex-fill">
                            ...
                            <table class="table table-hover my-0">
                                ...
                                <tbody id="data_body">
                                    ...
                                    $tot_exp = $i = 0;
                                    $deb_re = $db->exc_q("SELECT * FROM `debits` WHERE `date` LIKE '%$y-$m%' ORDER BY `d_id` DESC");
